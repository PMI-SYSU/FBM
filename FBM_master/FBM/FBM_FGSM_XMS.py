...
download_path_list = [
    "./data/weight/dF="+str(fermi_surface)+"_num="+str(num_dataset)+"_lam=0.01_"+str(run)+".pth" for run in runs
    #"./data/weight/dF="+str(fermi_surface)+"_num="+str(num_dataset)+"_lam=0.01_1.pth",
    #"./data/weight/dF="+str(fermi_surface)+"_num="+str(num_dataset)+"_lam=0.01_2.pth",
    #"./data/weight/dF="+str(fermi_surface)+"_num="+str(num_dataset)+"_lam=0.01_3.pth",
    #"./data/weight/dF="+str(fermi_surface)+"_num="+str(num_dataset)+"_lam=0.01_4.pth",
]
# 检查所有文件是否都存在
...
for run in runs:
    ...
    np.savetxt(f"data/FGSM_acc/FM_FGSM_acc_dF={fermi_surface}_num={num_dataset}_{run}.csv", final_acc_test_cols)
