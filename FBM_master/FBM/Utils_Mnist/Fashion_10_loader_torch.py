...
def load_data_wrapper(train_subset, test_subset):
    ...
    train_set = datasets.FashionMNIST(root='D:\Japan\work\G_map\FBM_master\FBM\Fashiondata', train=True, download=False, transform=transform)
    test_set = datasets.FashionMNIST(root='D:\Japan\work\G_map\FBM_master\FBM\Fashiondata', train=False, download=False, transform=transform)
