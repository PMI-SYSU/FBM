...
for num_dataset in (Num_data):
    for fermi_surface in fermi_surface_list:
        ...
        final_loss_test_row = []
        final_acc_test_row = []
        upload_weight = f"data/weight/NUM_dF={fermi_surface}_num={num_dataset}_{run}.pth"
        ...
        np.savetxt(f"data/acc/NUM_tra_dF={fermi_surface}_num={num_dataset}_{run}.csv", final_acc_tra_row)
        np.savetxt(f"data/acc/NUM_test_dF={fermi_surface}_num={num_dataset}_{run}.csv", final_acc_test_row)
        np.savetxt(f"data/loss/NUM_tra_dF={fermi_surface}_num={num_dataset}_{run}.csv", final_loss_tra_row)
        np.savetxt(f"data/loss/NUM_test_dF={fermi_surface}_num={num_dataset}_{run}.csv", final_loss_test_row)
